...
(function webpackUniversalModuleDefinition(root, factory) {
    if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && (typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["dibujo"] = factory();else root["dibujo"] = factory();
        ...
        /***/function (module, exports, __webpack_require__) {
            ...
            var Rect = /** @class */function (_super) {
                ...
                function Rect(data) {
                    ...
                    if (data.fill) _this.fill = data.fill;
                    if (data.stroke) _this.stroke = data.stroke;
                    if (data.lineWidth) _this.lineWidth = data.lineWidth;
                    if (data.lineColor) _this.lineColor = data.lineColor;
                    return _this;
                }
            ...
            var Arc = /** @class */function (_super) {
                ...
                Arc.prototype.renderChild = function () {
                    ...
                    this.childs.forEach(function (c) {
                        return c.context = _this.context;
                    });
                    this.childs.forEach(function (c) {
                        return c.render();
                    });
...
//# sourceMappingURL=/bundle.5079276f.map