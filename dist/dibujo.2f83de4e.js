...
},{"../Vector":14,"../Properties":76}],20:[function(require,module,exports) {
"use strict";
...
},{"../graphics/Graphic":17,"../Vector":14}],22:[function(require,module,exports) {
"use strict";
...
},{"./Camera":73,"./Media/Picture":20,"./Media/Video":22}],11:[function(require,module,exports) {
"use strict";
...
},{"./graphics/Graphic":17,"./Vector":14}],7:[function(require,module,exports) {
"use strict";
...
},{"./Graphic":17,"../Vector":14,"../LinearGradient":12}],19:[function(require,module,exports) {
"use strict";
...
},{"../Events/CircleEvents":77}],23:[function(require,module,exports) {
"use strict";
...
},{"./Graphic":17}],24:[function(require,module,exports) {
"use strict";
...
},{"../Vector":14,"./Event":79}],30:[function(require,module,exports) {
"use strict";
...
},{"./Scene":10,"./Render":11,"./LinearGradient":12,"./Group":7,"./Vector":14,"./Color":15,"./Media/Animation":16,"./graphics/Graphic":17,"./graphics/Ellipse":18,"./graphics/Poligon":19,"./Media/Picture":20,"./graphics/Circle":21,"./Media/Video":22,"./graphics/Rect":23,"./graphics/Line":24,"./graphics/Text":25,"./graphics/Arc":26,"./graphics/BezierCurve":27,"./graphics/QuadraticCurve":28,"./Events/Mouse":29,"./Events/KeyBoard":30}],4:[function(require,module,exports) {
"use strict";
...
var balls = [];
var _Circle = /** @class */function (_super) {
    __extends(_Circle, _super);
    function _Circle(data) {
        var _this = _super.call(this, data) || this;
        _this.vel = new index_1.Vector();
        _this.acc = new index_1.Vector();
        return _this;
    }
    _Circle.prototype.addForce = function (f) {
        this.acc.add(f);
    };
    _Circle.prototype.update = function () {
...
for (var y = 0; y < 10; y++) {
    for (var x = 0; x < 10; x++) {
        ...
        var circle = new _Circle({
            position: new index_1.Vector(x * spacing + 100, spacing * y + 100),
            color: 'white',
            z_index: 5
        });
        circle.c = color;
...
var _Line = /** @class */function (_super) {
    ...
    function _Line(data) {
        ...
        _this.rest = index_1.Vector.distance(data.start.position, data.end.position);
        return _this;
    }
    _Line.prototype.update = function () {
        var v = index_1.Vector.sub(this.b1.position, this.b2.position);
        v.normalize();
        var x = this.rest - index_1.Vector.distance(this.b1.position, this.b2.position);
        v.mult(x);
        v.mult(this.k);
        v.mult(0.25);
        this.b1.addForce(v);
...
var links = [];
var _loop_1 = function _loop_1(b1) {
    balls[b1].lines = [];
    for (var b2 = 0; b2 < balls.length; b2++) {
        if (b1 != b2) {
            var code = String(b1) + String(b2);
            var iCode = String(b1) + String(b2);
            if (!links.includes(code) || !links.includes(iCode)) {
                ...
                render.add(line);
                balls[b1].lines.push({ line: line, ball: balls[b2] });
                links.push(code);
                links.push(iCode);
            }
        }
    }
    balls[b1].mouseMove(function (mouse) {
        balls[b1].addForce(index_1.Vector.mult(index_1.Vector.normalize(index_1.Vector.sub(balls[b1].position, mouse)), 2));
    });
};
for (var b1 = 0; b1 < balls.length; b1++) {
    _loop_1(b1);
}
render.autoRender(function () {
    balls.forEach(function (ball) {
        ball.update();
        ball.lines.forEach(function (line) {
            line.line.end = index_1.Vector.sub(line.ball.position, ball.position);
            line.line.update();
        });
    });
});
...
*/
// render.autoRender()
},{"./src/index":7}],31:[function(require,module,exports) {
...
//# sourceMappingURL=/dibujo.2f83de4e.map